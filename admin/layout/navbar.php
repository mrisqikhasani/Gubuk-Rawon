		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
				<div class="sidebar-brand-icon rotate-n-15">
					<img src="../assets/img/about-us/logo 4.png" alt="logo" width="80px">
				</div>
				<div class="sidebar-brand-text mx-3">Gubuk Rawon</div>
			</a>
			...
			<!-- Nav Item - Dashboard -->
			<li class="nav-item <?php echo ($current_file == 'index.php' || $current_file == 'insertPemesanan.php') ? 'active' : '' ?> ">
			...
			<li class="nav-item <?php echo ($current_file == 'kasir.php' || $current_file == "insertPesananOffline.php") ? 'active' : '' ?> ">
